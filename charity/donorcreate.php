...
// Validate email
    ...
    // Check input errors before inserting in database
     if(empty($name_err) && empty($email_err) && empty($homeaddress_err) && empty($fooditem_err) && empty($itemquantity_err) && empty($itemamount_err)&& empty($destinationaddress_err)){
        ...
        $sql = "INSERT INTO DonorDonations (name,email, homeaddress,fooditem,itemquantity,itemamount, destinationaddress) VALUES (?, ?, ?, ?, ?, ?,?)";
...
<select class="form-control" name = "destinationaddress" >
                        ...
                        <center><a href="donorwelcome.php" class="btn btn-default">Cancel</a></center>
                    </form>
                </div>
            </div>        
        </div>

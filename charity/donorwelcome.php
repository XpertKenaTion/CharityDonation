          ...
          <div id="navbar-collapse" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="contactus.html">CONTACT US</a></li>
               ...
               <li class = "active"><a href="donorwelcome.php"> DONOR WELCOME</a></li>
             <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="donorreset.php">RESET YOUR PASSWORD</a></li>
                  <li><a href="donorlogout.php">SIGN OUT OF YOUR ACCOUNT</a></li>
                  
                </ul>
              </li>
              
              <li class="probootstra-cta-button last"><a href="donorcreate.php" class="btn btn-primary">Make Donation</a></li>
              <li class="probootstra-cta-button last"><a href="php_stripe_paypage-master/index.php" class="btn btn-primary">Make Payment</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="probootstrap-slider-text probootstrap-animate" data-animate-effect="fadeIn">
                ...
                <li><h1 class="probootstrap-heading probootstrap-animate">Hello Donor, <?php echo htmlspecialchars($_SESSION["username"]); ?>. Welcome to iDONATE.</h1></li>
      ...
      <section class="probootstrap-half">
        ...
        <div class="text">
          <div class="probootstrap-animate">
            ...
            <p>Welcome to iDONATE where you will be able to interact with our site, learn more about us, be able to make donations towards helping the affected areas and the donations may be inform of food items or payemnt.</p>
          ...
          <div class="row">
            <div class="col-md-4 probootstrap-animate">
              <div class="probootstrap-footer-widget">
                <h3>ABOUT US</h3>
                <b><p>iDONATE is an interactive site where it creates  awareness on areas that are worst hit by malnutrition and through that we are able to make donations to those areas inorder to help save those lives.</p></b>
                <p><a href="about.html" class="btn btn-primary">About Us</a></p>
            ...
            <div class="col-md-4 probootstrap-animate">
              <div class="probootstrap-footer-widget">
                ...
                <p><a href="php_stripe_paypage-master/index.php"class="btn btn-primary">Make Payment</a></p>
              </div>
            </div>
